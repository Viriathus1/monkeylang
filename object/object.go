...
func (i *Integer) Inspect() string  { return fmt.Sprintln(i.Value) }
...
func (b *Boolean) Inspect() string  { return fmt.Sprintln(b.Value) }
...
func (q *Quote) Inspect() string {
	return fmt.Sprintln("QUOTE(" + q.Node.String() + ")")
}
